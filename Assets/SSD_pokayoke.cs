...
{
    public class SSD_pokayoke : BaseImagePredictor<sbyte>
    {
        ...
        public SSD_pokayoke(string modelPath) : base(modelPath, true)
        {
        }
        ...
        public Result[] GetResults()
        {
            for (int i = 0; i < 10; i++)
            {
                ...
                results[i] = new Result()
                {
                    ...
                    score = outputs2[i],
                    rect = new Rect(left, top, right - left, top - bottom /*bottom - top*/),
                };
            }
            return results;
        }
